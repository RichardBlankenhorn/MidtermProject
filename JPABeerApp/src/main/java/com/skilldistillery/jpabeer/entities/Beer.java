...
public class Beer {
	...
	public Beer(int id, String name, double cost, double abv, String description, Brewery brewery, String imageUrl,
			Category category, double ibu, int rating) {
		super();
		this.id = id;
		this.name = name;
		this.cost = cost;
	...
	public String toString() {
		...
		builder.append("Beer [id=").append(id).append(", name=").append(name).append(", cost=").append(cost)
				.append(", abv=").append(abv).append(", description=").append(description).append(", imageUrl=")
				.append(imageUrl).append(", ibu=").append(ibu).append(", rating=").append(rating).append("]");
